...
import { RecentActivityCard, RecentActivityIcon } from "../components/RecentActivity"
      ...
      <div className="flex flex-col">
        ...
        <div className='bg-paypal-100 shadow-lg rounded-xl h-min mt-8 mb-10'>
          ...
          {users.map(function (element, index) {
            return (
              <RecentActivityCard key={index} name={element.name} date={element.date} amount={element.amount} />
            )
          })}
        </div>
      </div>
